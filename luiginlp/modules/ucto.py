...
class Ucto_tok2folia(Task):
    ...
    in_tok = InputSlot() #will be linked to an out_* slot of another module in the workflow specification

    def out_folia(self):
        return self.outputfrominput(inputformat='tok',stripextension='.tok', addextension='.folia.xml')
